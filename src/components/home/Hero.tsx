...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-5rem)] flex items-center justify-center overflow-hidden py-16 md:py-28 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-secondary/20 via-background to-background">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 text-center max-w-full overflow-hidden">
        ...
        >
          <h1 className="text-4xl md:text-7xl lg:text-8xl font-serif font-bold tracking-tight text-foreground drop-shadow-sm leading-tight whitespace-normal md:whitespace-nowrap break-words">
            Inner Balance, <span className="text-foreground whitespace-nowrap">Outer Growth</span>
          </h1>
        ...
        >
          <p className="font-bold text-foreground text-2xl mb-4">
          ...
          <div className="space-y-6 text-foreground/90">
            ...
            <p>
              <span className="font-bold text-foreground">ManoArohan</span> is a space to help you make sense of your emotions and find steadiness again, at your own pace.
            </p>
          </div>
        </motion.div>
      </div>
